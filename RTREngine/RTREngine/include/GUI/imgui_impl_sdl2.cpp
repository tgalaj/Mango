...
void ImGui_ImplSDL2_CreateFontsTexture()
{
    ImGuiIO& io = ImGui::GetIO();
...
#undef OFFSETOF
    ...
    ImGui_ImplSDL2_CreateFontsTexture();
	...
	while (SDL_PollEvent(&event))
	{
		switch (event.type)
		{
		    ...
		    case SDL_MOUSEWHEEL:
		    	...
		    	break;
		    case SDL_TEXTINPUT:
		    	ImGui_ImplSDL2_CharCallback(event.text.text[0]);
		    	break;
		    case SDL_KEYUP:
		    	ImGui_ImplSDL2_KeyCallback(event.key.keysym.sym&~SDLK_SCANCODE_MASK, false);
		    	break;
		    case SDL_KEYDOWN:
		    	ImGui_ImplSDL2_KeyCallback(event.key.keysym.sym&~SDLK_SCANCODE_MASK, true);
		    	break;
		    default:
		    	break;
		}
