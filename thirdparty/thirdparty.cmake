...
# entityx
find_library(ENTITYX_LIBRARY "entityx" "/usr/lib" "/usr/local/lib")
find_path(ENTITYX_INCLUDE_DIR "entityx/entityx.h" "/usr/include" "/usr/local/include")
...
if((NOT ENTITYX_LIBRARY) OR (NOT ENTITYX_INCLUDE_DIR))
	...
	set(ENTITYX_INCLUDE_DIR "${ENTITYX_DIR}")
endif()
