...
namespace mango
{
    ...
    ref<Material> AssetManagerOld::createMaterial(const std::string& materialName)
    {
        MG_PROFILE_ZONE_SCOPED;
    ...
    ref<Mesh> AssetManagerOld::createMeshFromFile(const std::string & filename)
    {
        MG_PROFILE_ZONE_SCOPED;
    ...
    ref<Shader> AssetManagerOld::createShader(const std::string & shaderName,
    ...
    ref<Font> AssetManagerOld::getFont(const std::string& fontName)
    {
        MG_PROFILE_ZONE_SCOPED;
    ...
    ref<Shader> AssetManagerOld::getShader(const std::string& shaderName)
    {
        MG_PROFILE_ZONE_SCOPED;
        if (m_loadedShaders.contains(shaderName))
        {
    ...
    ref<Mesh> AssetManagerOld::getMesh(const std::string& staticMeshName)
    {
        MG_PROFILE_ZONE_SCOPED;
