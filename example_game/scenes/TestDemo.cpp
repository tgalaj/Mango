...
void TestDemo::init()
{
    ...
    auto font = mango::CoreAssetManager::createFont("Droid48", "res/fonts/Roboto-Regular.ttf", 48.0f);

    /*auto skybox = std::make_shared<mango::Skybox>("res/skyboxes/stormydays/",
                                                   "stormydays_lf.tga",
                                                   "stormydays_rt.tga",
                                                   "stormydays_up.tga", 
                                                   "stormydays_dn.tga", 
                                                   "stormydays_ft.tga", 
                                                   "stormydays_bk.tga" );*/
    auto skybox = std::make_shared<mango::Skybox>("res/skyboxes/cold/",
                                                   "right.jpg",
                                                   "left.jpg",
                                                   "top.jpg", 
                                                   "bottom.jpg", 
    ...
    auto cyborg_model = mango::CoreAssetManager::createModel("res/models/cyborg/cyborg.obj");
    auto zen3c_model = mango::CoreAssetManager::createModel("res/models/Zen3C/Zen3C.X");
    auto damaged_helmet_model = mango::CoreAssetManager::createModel("res/models/damaged_helmet/DamagedHelmet.gltf");
    ...
    auto brickwall_normal_tex = mango::CoreAssetManager::createTexture2D("res/textures/brickwall_normal.jpg");
    auto bricks2              = mango::CoreAssetManager::createTexture2D("res/textures/bricks2.jpg", true);
    auto bricks2_depth        = mango::CoreAssetManager::createTexture2D("res/textures/bricks2_disp.jpg");
    auto bricks2_normal       = mango::CoreAssetManager::createTexture2D("res/textures/bricks2_normal.jpg");
    auto window_tex           = mango::CoreAssetManager::createTexture2D("res/textures/window.png");
    auto grass_tex            = mango::CoreAssetManager::createTexture2D("res/textures/grass.png");
    auto opengl_logo          = mango::CoreAssetManager::createTexture2D("res/textures/opengl.png");
...
//    mango::GUI::text(mango::CoreAssetManager::getFont("Droid48"), "Hello ImGUI Text Demo2!", { mango::Window::getWidth() / 2.0f, pos}, 48.0f, glm::vec4(1.0, 0.0, 0.0, 1.0), true, false);
    mango::GUI::image(mango::CoreAssetManager::getTexture2D("res/textures/opengl.png"), { mango::Window::getWidth() - 200, 0 }, { mango::Window::getWidth(), 100 }, { 1.0f, 1.0f, 1.0f, 0.5f });
